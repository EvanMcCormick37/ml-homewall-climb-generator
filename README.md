...
The climbs you see being generated here are completely novel climbs generated by a Diffusion generative model! The coolest part about this model is that it should in theory be able to generate reasonable climbs for *any* system board, provided that the user accurately uploads the board's hold positions. My next step is to re-upload my homewall to this database and generate some climbs for it.
