...
This is an open-source application which leverages ML models to set custom climbs on homewalls and system boards. It is also an open repository of climbs and spray-walls/system boards.
